...
while true; do
        ...
        read -p "(1) Update or (2) Rollback Production Web Server: " decide;
        case $decide in
                1 )
                        ...
                        case $answer in
                                [Yy]* )
                                        ...
                                        rsync -a testserver@172.23.112.211:/var/www/html/ /var/www/html/
                        ...
                        ;;
                2 )
                        read -p "Rollback Production Web Server [Y/y] or [N/n]? " answer2
                        case $answer2 in
                                [Yy]* )
