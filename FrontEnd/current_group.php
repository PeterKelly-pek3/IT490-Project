...
if (isset($_POST['TeamToBetOn'])) {
	...
	foreach($odds_response as $data) {
		...
		echo "<br>";
		echo "<input style='border:2px solid Tomato;' id='username' name='username' type='text' value=''/>";
		...
		echo " <button style='border:2px solid Tomato;' type='submit' name='HomeTeamBet'>".$hometeam."</button>";
		echo "</form>";
		echo "<br>";  
		echo "<form action='current_group.php' method='post'>";
		echo "<label for='username'>Enter Username:</label><br/>";
		...
		echo " <input type='hidden' id='hometeam' name='hometeam' value='".$hometeam."'>";
		echo " <input type='hidden' id='awayteam' name='awayteam' value='".$awayteam."'>";
		echo	"<button style='border:2px solid Tomato;' type='submit' name='AwayTeamBet'>".$awayteam."</button>";
		echo "</form>";
		echo "<br>";
		echo "</div>";
